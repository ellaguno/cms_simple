...
return [
    ...
    'settings' => ['Redacción con IA' => [
        ...
        'rd_openrouter_key' => ['type' => 'text', 'label' => 'OpenRouter: clave (vacío = la del importador de diseño, si la hay)', 'half' => true],
        ...
        'rd_image_model' => ['type' => 'text', 'label' => 'Modelo de imagen', 'default' => 'gpt-image-1', 'placeholder' => 'gpt-image-1, dall-e-3', 'half' => true],
        'rd_image_prompt' => ['type' => 'textarea', 'rows' => 2, 'label' => 'Instrucción para la imagen ({topic} se sustituye)', 'default' => 'Ilustración editorial moderna y limpia sobre "{topic}", colores sobrios, sin texto ni logotipos.'],

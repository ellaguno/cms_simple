...
function cms_registry_clean(array $it, string $from): ?array
{
    ...
    return [
        ...
        'author_url' => preg_match('#^https?://#i', (string) ($it['author_url'] ?? '')) ? (string) $it['author_url'] : '',
        'demo' => preg_match('#^https?://#i', (string) ($it['demo'] ?? '')) ? (string) $it['demo'] : '',
        'inspired' => (string) ($it['inspired'] ?? ''), 'inspired_url' => preg_match('#^https?://#i', (string) ($it['inspired_url'] ?? '')) ? (string) $it['inspired_url'] : '',

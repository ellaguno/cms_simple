...
return [
    ...
    'settings' => ['Audio: texto a voz' => [
        ...
        'audio_openai_key'   => ['show_if' => ['audio_provider' => 'openai'], 'type' => 'text', 'label' => 'OpenAI: clave (sk-…)', 'half' => true],
        'audio_openai_voice' => ['show_if' => ['audio_provider' => 'openai'], 'type' => 'select', 'label' => 'OpenAI: voz', 'options' => $voicesOpenAI, 'default' => 'nova', 'half' => true],
        'audio_openai_model' => ['show_if' => ['audio_provider' => 'openai'], 'type' => 'text', 'label' => 'OpenAI: modelo', 'default' => 'gpt-4o-mini-tts', 'placeholder' => 'gpt-4o-mini-tts, tts-1, tts-1-hd', 'half' => true],
        'audio_openai_instructions' => ['show_if' => ['audio_provider' => 'openai'], 'type' => 'text', 'label' => 'OpenAI: instrucciones de tono (solo gpt-4o-mini-tts, opcional)', 'placeholder' => 'Lee con calma, tono cercano, en español de México', 'half' => true],
        'audio_elevenlabs_key'   => ['show_if' => ['audio_provider' => 'elevenlabs'], 'type' => 'text', 'label' => 'ElevenLabs: clave', 'half' => true],
        'audio_elevenlabs_voice' => ['show_if' => ['audio_provider' => 'elevenlabs'], 'type' => 'text', 'label' => 'ElevenLabs: ID de la voz', 'default' => 'pNInz6obpgDQGcFmaJgB', 'help' => 'Los ID están en la biblioteca de voces de ElevenLabs.', 'half' => true],
        'audio_elevenlabs_model' => ['show_if' => ['audio_provider' => 'elevenlabs'], 'type' => 'text', 'label' => 'ElevenLabs: modelo', 'default' => 'eleven_multilingual_v2', 'half' => true],
        'audio_azure_key'    => ['show_if' => ['audio_provider' => 'azure'], 'type' => 'text', 'label' => 'Azure: clave', 'half' => true],
        'audio_azure_region' => ['show_if' => ['audio_provider' => 'azure'], 'type' => 'text', 'label' => 'Azure: región', 'default' => 'eastus', 'placeholder' => 'eastus, westeurope…', 'half' => true],
        'audio_azure_voice'  => ['show_if' => ['audio_provider' => 'azure'], 'type' => 'text', 'label' => 'Azure: voz', 'default' => 'es-MX-DaliaNeural', 'placeholder' => 'es-MX-DaliaNeural, es-MX-JorgeNeural, en-US-JennyNeural', 'half' => true],
        'audio_google_key'   => ['show_if' => ['audio_provider' => 'google'], 'type' => 'text', 'label' => 'Google Cloud: clave de API', 'half' => true],
        'audio_google_voice' => ['show_if' => ['audio_provider' => 'google'], 'type' => 'text', 'label' => 'Google Cloud: voz', 'default' => 'es-US-Neural2-A', 'placeholder' => 'es-US-Neural2-A, es-ES-Neural2-B, en-US-Neural2-C', 'half' => true],

...
return [
    ...
    'types' => [
        ...
        'noticias' => [
            'label' => 'Noticias y artículos', 'label_singular' => 'Artículo', 'group' => 'Contenido',
            'help' => 'Artículos con fondo claro, como PyMEs, Feng Shui o el Premio a! Diseño: imagen arriba, fecha y etiqueta, título con icono y texto. Los tres más recientes salen en las tarjetas de "Valor agregado" de la portada. Para publicar uno nuevo: Nuevo artículo.',
            'routes' => ['es' => 'noticias'],
            ...
            'fields' => [
                ...
                'hero'    => ['type' => 'image', 'label' => 'Imagen grande arriba del artículo (vacío = la de la tarjeta)', 'sidebar' => true],
                'tag'     => ['type' => 'text', 'label' => 'Etiqueta a la derecha de la fecha (cliente, tema; opcional)', 'i18n' => true, 'sidebar' => true],

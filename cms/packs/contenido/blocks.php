...
return [
    ...
    'indice' => [
        'label' => 'Índice del sitio', 'group' => 'Contenido dinámico',
        'desc' => 'Mapa HTML con todas las páginas publicadas: por colección, por año, por letra inicial o por categoría, en una o varias columnas y con las páginas hijas anidadas. Sale del índice ligero, así que aguanta miles de páginas. Sirve de mapa del sitio para visitantes y buscadores.',
        'wrap_class' => 'cms-sec',
        'fields' => [
            'title'      => ['type' => 'text', 'label' => 'Título (opcional)'],
            'subtitle'   => ['type' => 'text', 'label' => 'Subtítulo (opcional)'],
            'source'     => ['type' => 'select', 'label' => 'Qué incluir', 'options' => ['all' => 'Todas las colecciones'] + $types, 'default' => 'all', 'half' => true],
            'group'      => ['type' => 'select', 'label' => 'Agrupar', 'options' => ['type' => 'Por colección', 'year' => 'Por año', 'letter' => 'Por letra inicial', 'category' => 'Por categoría', 'none' => 'Sin agrupar'], 'default' => 'type', 'half' => true],
            'sort'       => ['type' => 'select', 'label' => 'Orden dentro de cada grupo', 'options' => ['default' => 'El de la colección', 'title' => 'Alfabético', 'date' => 'Más recientes primero'], 'default' => 'default', 'half' => true],
            'columns'    => ['type' => 'select', 'label' => 'Columnas', 'options' => ['1' => '1', '2' => '2', '3' => '3'], 'default' => '2', 'half' => true],
            'limit'      => ['type' => 'number', 'label' => 'Máximo por grupo (0 = todos; el resto se enlaza al índice de la colección)', 'default' => 0, 'min' => 0, 'max' => 5000, 'half' => true],
            'tree'       => ['type' => 'checkbox', 'label' => 'Mostrar', 'text' => 'Las páginas hijas anidadas bajo su padre (colecciones en árbol)', 'default' => true],
            'pages'      => ['type' => 'checkbox', 'label' => ' ', 'text' => 'Las páginas fijas del sitio y los índices de las colecciones (grupo "Secciones")', 'default' => true],
            'show_date'  => ['type' => 'checkbox', 'label' => ' ', 'text' => 'La fecha junto a cada título', 'default' => false],
            'show_count' => ['type' => 'checkbox', 'label' => ' ', 'text' => 'Cuántas páginas tiene cada grupo', 'default' => true],
            'empty'      => ['type' => 'text', 'label' => 'Texto si no hay nada publicado', 'default' => 'Aún no hay páginas publicadas.'],
        ],
        'sample' => ['title' => 'Todo lo que hay en este sitio', 'subtitle' => 'Cada página publicada, ordenada por sección'],
    ],
];
